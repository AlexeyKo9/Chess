public class Queen extends ChessPiece {
    ...
    public boolean canMoveToPosition(ChessBoard chessBoard, int line, int column, int toLine, int toColumn) {
        ...
        if (line != toLine && column != toColumn &&                                                       //Проверка условий
                getMax(line, toLine) - getMin(line, toLine) == getMax(column, toColumn) - getMin(column, toColumn) &&
                (line >= 0 && line < 8) && (column >= 0 && column < 8) && (toLine >= 0 && toLine < 8) &&
            ...
            if ((column == getMin(column, toColumn) && line == getMax(line, toLine)) ||                    //Двигаемся вправо-вниз или влево-вверх
                ...
                int fromL = getMin(line, toLine);                                               //Двигаемся влево-вниз или вправо-вверх
                int fromC = getMin(column, toColumn);
        ...
        } else if ((line >= 0 && line < 8) && (column >= 0 && column < 8) && (toLine >= 0 && toLine < 8) &&             //Двигаемся вверх-вниз
                (toColumn >= 0 && toColumn < 8)) {
            if (column == toColumn) {
